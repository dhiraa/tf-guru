...
```python
! ls ../docs/assets/2017-11-11-TFRecord_files/*
```

    ../docs/assets/2017-11-11-TFRecord_files/2017-11-11-TFRecord_20_1.png
...
```
    ...
    [NbConvertApp] Writing 10450 bytes to ../docs/_posts/2017-11-11-TFRecord.md
